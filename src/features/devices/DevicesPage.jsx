...
import { FaExclamationTriangle, FaBoxOpen, FaClock, FaMicrochip } from "react-icons/fa";
...
export default function DevicesPage() {
  ...
  return (
    <div className="p-6 bg-gray-900 min-h-screen text-gray-100">
      <h1 className="text-3xl md:text-4xl font-extrabold mb-6 bg-gradient-to-r from-blue-400 via-green-400 to-purple-400 bg-clip-text text-transparent">
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        <input
          ...
          className="bg-gray-800 text-gray-100 border border-gray-700 rounded-md px-3 py-2 w-64 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />

        <select
          value={sortOrder}
          onChange={(e) => setSortOrder(e.target.value)}
          className="bg-gray-800 text-gray-100 border border-gray-700 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
